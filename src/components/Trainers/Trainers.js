...
const Trainers = () => {
    return (
        <section className="trainers" css={styles}>
            <Heading title="OUR TRAINERS" info="our trainers are best in the country and so professional." />
            <Container>
                <TrainerCard trainerImg={Trainer3} trainerName="Usme Richi" trainerType="Woman Trainer" />
                <TrainerCard trainerImg={Trainer1} trainerName="Akbar Khan" trainerType="Men Trainer" />
                <TrainerCard trainerImg={Trainer2} trainerName="fahim Uddin" trainerType="Men Trainer" />
            </Container>
        </section>
    )
}
