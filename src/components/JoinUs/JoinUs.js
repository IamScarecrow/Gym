...
const JoinUs = () => {
    return (
        <section className="joinUs" css={styles}>
            <div className="wrap">
                <div className="img1">
                    <JoinUsInfo title="FOR WOMEN" info="Only we are providing best fitness service for woman with best woman trainer" />
                </div>
            </div>
            <div className="wrap">
                <div className="img2">
                    <JoinUsInfo title="FOR GUYS" info="Best of the best for guy. Trainer is very professional in fitness." />
                </div>
            </div>
